...
: ${AMENT_CURRENT_PREFIX:="/workspaces/citros_example_robotic_arm/franka_ros2_ws/install/joint_effort_trajectory_controller"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/joint_effort_trajectory_controller/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/joint_effort_trajectory_controller/environment/library_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/joint_effort_trajectory_controller/environment/path.sh"
