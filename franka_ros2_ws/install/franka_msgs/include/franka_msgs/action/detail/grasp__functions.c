  ...
  franka_msgs__action__Grasp_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    franka_msgs__action__Grasp_Goal * data =
      (franka_msgs__action__Grasp_Goal *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!franka_msgs__action__Grasp_Goal__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          franka_msgs__action__Grasp_Goal__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  franka_msgs__action__Grasp_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    franka_msgs__action__Grasp_Result * data =
      (franka_msgs__action__Grasp_Result *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!franka_msgs__action__Grasp_Result__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          franka_msgs__action__Grasp_Result__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  franka_msgs__action__Grasp_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    franka_msgs__action__Grasp_Feedback * data =
      (franka_msgs__action__Grasp_Feedback *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!franka_msgs__action__Grasp_Feedback__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          franka_msgs__action__Grasp_Feedback__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  franka_msgs__action__Grasp_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    franka_msgs__action__Grasp_SendGoal_Request * data =
      (franka_msgs__action__Grasp_SendGoal_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!franka_msgs__action__Grasp_SendGoal_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          franka_msgs__action__Grasp_SendGoal_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  franka_msgs__action__Grasp_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    franka_msgs__action__Grasp_SendGoal_Response * data =
      (franka_msgs__action__Grasp_SendGoal_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!franka_msgs__action__Grasp_SendGoal_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          franka_msgs__action__Grasp_SendGoal_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  franka_msgs__action__Grasp_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    franka_msgs__action__Grasp_GetResult_Request * data =
      (franka_msgs__action__Grasp_GetResult_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!franka_msgs__action__Grasp_GetResult_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          franka_msgs__action__Grasp_GetResult_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  franka_msgs__action__Grasp_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    franka_msgs__action__Grasp_GetResult_Response * data =
      (franka_msgs__action__Grasp_GetResult_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!franka_msgs__action__Grasp_GetResult_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          franka_msgs__action__Grasp_GetResult_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  franka_msgs__action__Grasp_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    franka_msgs__action__Grasp_FeedbackMessage * data =
      (franka_msgs__action__Grasp_FeedbackMessage *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!franka_msgs__action__Grasp_FeedbackMessage__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          franka_msgs__action__Grasp_FeedbackMessage__fini(&data[i]);
        }
        free(data);
        return false;
      }
