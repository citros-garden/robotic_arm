...
{
  return max_serialized_size_Homing_Goal(full_bounded, 0);
}
...
{
  return max_serialized_size_Homing_Result(full_bounded, 0);
}
...
{
  return max_serialized_size_Homing_Feedback(full_bounded, 0);
}
...
{
bool cdr_serialize(
  const franka_msgs::action::Homing_Goal &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
{
  return max_serialized_size_Homing_SendGoal_Request(full_bounded, 0);
}
...
{
  return max_serialized_size_Homing_SendGoal_Response(full_bounded, 0);
}
...
{
  return max_serialized_size_Homing_GetResult_Request(full_bounded, 0);
}
...
{
bool cdr_serialize(
  const franka_msgs::action::Homing_Result &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
{
  return max_serialized_size_Homing_GetResult_Response(full_bounded, 0);
}
...
{
bool cdr_serialize(
  const franka_msgs::action::Homing_Feedback &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
{
  return max_serialized_size_Homing_FeedbackMessage(full_bounded, 0);
}
