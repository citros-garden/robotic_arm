...
Describer:  
			...
			/src/inverse_kinematic_pkg/config/simple_controller.yaml
...
def generate_launch_description():
	...
	robot_config = os.path.join(
        get_package_share_directory('inverse_kinematic_pkg'),
        'config',
        'params.yaml'
        )
	robot_model = 'a0912'

	xacro_file = get_package_share_directory('inverse_kinematic_pkg') + '/description'+'/xacro/'+ robot_model +'.urdf.xacro'

	setpoints = Node(
        package = 'inverse_kinematic_pkg',
        name = 'inverse_kinematic_pkg',
        executable = 'inverse_kinematic_pkg',
	...
	world = os.path.join(get_package_share_directory('inverse_kinematic_pkg'), 'worlds', world_file_name)
